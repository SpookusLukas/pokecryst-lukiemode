...
; - BattleAnimations (see data/moves/animations.asm)
	...
	const DRAGON_CLAW  ; 141
	const DRAGON_PULSE ; 142
	const DRAGON_RUSH  ; 143
	const DARK_PULSE   ; 144
	const NASTY_PLOT   ; 145
	const SNARL        ; 146
	const NIGHT_SLASH  ; 147
	const FLASH_CANNON ; 148
	const IRON_DEFENSE ; 149
	const MIRROR_SHOT  ; 14a
	const IRON_HEAD    ; 14b
	const BULLET_PUNCH ; 14c
	const SMART_STRIKE ; 14d
	const VOLT_TACKLE  ; 14e
	const SCALD        ; 14f
	const BULK_UP      ; 150
	const CALM_MIND    ; 151
	const COSMIC_POWER ; 152
	const DRAGON_DANCE ; 153
	const HEX          ; 154
	const VENOSHOCK    ; 155
	const FREEZE_DRY   ; 156
	const OVERHEAT     ; 157
	const DRACO_METEOR ; 158
	const CLOSE_COMBAT ; 159
	const FACADE       ; 15a
	const ACROBATICS   ; 15b
	const POISON_FANG  ; 15c
	const MUD_SHOT     ; 15d
	const HURRICANE    ; 15e
	const WILL_O_WISP  ; 15f
	const BLAZE_KICK   ; 160
	const MUDDY_WATER  ; 161
;	const PAYBACK      ; 162
;	const AVALANCHE    ; 163
	const BRICK_BREAK  ; 164
